  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center bg-gray-950 text-white px-4">
      <form
        ...
        className="relative w-full max-w-md bg-gray-900 border border-gray-700 p-6 rounded-xl shadow-lg space-y-6"
      >
        ...
        <h1 className="text-2xl font-semibold text-center">
          Welcome to{" "}
          <span className="block text-green-500">{data?.restaurant}</span>
        </h1>

        <div className="space-y-2">
          <label htmlFor="name" className="text-sm">
            {t("Login.enterFullName")}
          </label>
          <input
            type="text"
            name="name"
